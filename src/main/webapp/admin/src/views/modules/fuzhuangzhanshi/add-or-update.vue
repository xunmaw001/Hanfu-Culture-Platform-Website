  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fuzhuangbianhao" label="服装编号" prop="fuzhuangbianhao">
              <el-input v-model="ruleForm.fuzhuangbianhao" 
                placeholder="服装编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="服装名称" prop="fuzhuangmingcheng">
              <el-input v-model="ruleForm.fuzhuangmingcheng" 
                placeholder="服装名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服装类别" prop="fuzhuangleibie">
          <el-select v-model="ruleForm.fuzhuangleibie" placeholder="请选择服装类别">
            <el-option
                v-for="(item,index) in fuzhuangleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="服装类别" prop="fuzhuangleibie">
	      <el-input v-model="ruleForm.fuzhuangleibie"
                placeholder="服装类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fuzhuangtupian" label="服装图片" prop="fuzhuangtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fuzhuangtupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                            <el-col :span="12">
          ...
          <el-form-item class="input" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="价格" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="服装介绍" prop="fuzhuangjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fuzhuangjieshao" label="服装介绍" prop="fuzhuangjieshao">
                    <span v-html="ruleForm.fuzhuangjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuzhuangmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='fuzhuangleibie'){
            this.ruleForm.fuzhuangleibie = obj[o];
	    this.ro.fuzhuangleibie = true;
            continue;
          }
	            	            if(o=='fuzhuangyanse'){
	...
	this.ruleForm.fuzhuangjieshao = this.ruleForm.fuzhuangjieshao.replace(reg,'../../../ssm2b4x5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fuzhuangzhanshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fuzhuangzhanshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
