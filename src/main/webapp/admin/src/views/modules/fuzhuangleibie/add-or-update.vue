<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服装类别" prop="fuzhuangleibie">
          <el-input v-model="ruleForm.fuzhuangleibie" 
              placeholder="服装类别" clearable  :readonly="ro.fuzhuangleibie"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  data() {
	...
	fuzhuangleibie : false,
            ...
            ruleForm: {
                          ...
                          rules: {
                  fuzhuangleibie: [
                            { required: true, message: '服装类别不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fuzhuangleibie/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fuzhuangleibieCrossAddOrUpdateFlag = false;
                  this.parent.search();
